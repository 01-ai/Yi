...
| 类型        | 教程                                                      |      日期      |     作者     |
|:-------------|:--------------------------------------------------------|:----------------|:----------------|
| GitHub 项目  | [基于youtube视频（计划支持bilibili等其他平台）和零一万物大模型构建大语言模型高质量训练数据集（计划支持可自定义输出的训练数据格式）](https://github.com/zjrwtx/VideoQA_databuilder)              |  2024-04-25  |  [正经人王同学](https://github.com/zjrwtx)  |

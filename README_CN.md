...
- [📌 如何使用 Yi?](#-如何使用-yi)
  - [快速上手](#快速上手)
    - [选择学习路径](#选择学习路径)
      - [🎯 在本地部署 Yi](#-在本地部署-yi)
      - [🎯 不在本地部署 Yi 模型](#-不在本地部署-yi-模型)
        - [🙋‍♀️ 使用 Yi API](#️-使用-yi-api)
        - [🙋‍♀️ 使用 Yi Playground](#️-使用-yi-playground)
        - [🙋‍♀️ 使用 Yi Chat](#️-使用-yi-chat)
    - [快速上手 - PyPi (pip install)](#快速上手---pypi-pip-install)
      - [第 0 步：前提条件](#第-0-步前提条件)
      - [第 1 步：准备环境](#第-1-步准备环境)
      - [第 2 步：下载模型](#第-2-步下载模型)
      - [第 3 步：进行推理](#第-3-步进行推理)
        - [使用 Yi Chat 模型进行推理](#使用-yi-chat-模型进行推理)
        - [使用 Yi Base 模型进行推理](#使用-yi-base-模型进行推理)
    - [快速上手 - Docker](#快速上手---docker)
    - [快速上手 - conda-lock](#快速上手---conda-lock)
    - [快速上手 - llama.cpp](#快速上手---llamacpp)
      - [步骤 0：前提条件](#步骤-0前提条件)
...
| github项目       | [基于零一万物yi-34b-chat-200k输入任意文章地址，点击按钮即可生成无广告或推广内容的简要笔记，并生成分享图给好友](https://github.com/zjrwtx/open_summary)              |  2024-04-24  |  [正经人王同学](https://github.com/zjrwtx)  |

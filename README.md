...
- [How to use Yi?](#how-to-use-yi)
  - [Quick start](#quick-start)
    - [Choose your path](#choose-your-path)
      - [🎯 Deploy Yi locally](#-deploy-yi-locally)
      - [🎯 Not to deploy Yi locally](#-not-to-deploy-yi-locally)
        - [🙋‍♀️ Run Yi with APIs](#️-run-yi-with-apis)
        - [🙋‍♀️ Run Yi in playground](#️-run-yi-in-playground)
        - [🙋‍♀️ Chat with Yi](#️-chat-with-yi)
    - [Quick start - pip](#quick-start---pip)
      ...
      - [Step 3: Perform inference](#step-3-perform-inference)
        - [Perform inference with Yi chat model](#perform-inference-with-yi-chat-model)
        - [Perform inference with Yi base model](#perform-inference-with-yi-base-model)
    - [Quick start - Docker](#quick-start---docker)
    - [Quick start - conda-lock](#quick-start---conda-lock)
    - [Quick start - llama.cpp](#quick-start---llamacpp)
      - [Step 0: Prerequisites](#step-0-prerequisites-1)
      - [Step 1: Download `llama.cpp`](#step-1-download-llamacpp)
      - [Step 2: Download Yi model](#step-2-download-yi-model)
      - [Step 3: Perform inference](#step-3-perform-inference-1)
    ...
    - [Finetune code for Yi 6B and 34B](#finetune-code-for-yi-6b-and-34b)
    ...
    - [Quantization](#quantization)
      ...
      - [AWQ quantization](#awq-quantization)
        - [Do Quantization](#do-quantization-1)
        - [Run Quantized Model](#run-quantized-model-1)

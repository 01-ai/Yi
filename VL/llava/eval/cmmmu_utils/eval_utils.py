...
# ----------- Process Short Ans -------------
# def get_short_ans_prediction(args, content):
#     """get the prediction from the generated content"""
#     if args.mmodel_type in ['open_flamingo']:
#         if 'Answer:' in content:
#             content = content.split('Answer:')[1].split('<|endofchunk')[0].strip()
